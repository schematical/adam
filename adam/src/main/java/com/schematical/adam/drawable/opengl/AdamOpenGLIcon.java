...
public class AdamOpenGLIcon extends AdamOpenGLDrawable {
    ...
    public AdamOpenGLIcon() {
        ...
        int vertexShader = AdamOpenGLRenderer.loadShader(GLES20.GL_VERTEX_SHADER, vertexShaderCode);
        int fragmentShader = AdamOpenGLRenderer.loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentShaderCode);
    ...
    public void draw(float[] mvpMatrix) {
        ...
        AdamOpenGLRenderer.checkGlError("glGetUniformLocation");

        // Apply the projection and view transformation
        GLES20.glUniformMatrix4fv(mMVPMatrixHandle, 1, false, mvpMatrix, 0);
        AdamOpenGLRenderer.checkGlError("glUniformMatrix4fv");
